...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/fkH9gziExU)
...
```sh
npx nx serve my-todo-app
```

To create a production bundle:

```sh
npx nx build my-todo-app
```

To see all available targets to run for a project, run:

```sh
npx nx show project my-todo-app
```
